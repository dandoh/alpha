...
var originPosition = function originPosition(_ref) {
  var x = _ref.x,
      y = _ref.y,
      svg = _ref.svg;
  ...
  var processFirstRoll = function processFirstRoll() {
    ...
    boundNodes.forEach(function (node) {
      ...
      node.circle.mousedown(function (e) {
        ...
        try {
          for (var _iterator8 = node.neighbors[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
            ...
            try {
              ...
              for (var _iterator9 = findCenters({ x1: x1, y1: y1, x2: x2, y2: y2, radius: ballDiameter / 2 })[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                ...
                try {
                  for (var _iterator10 = node.neighbors[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
